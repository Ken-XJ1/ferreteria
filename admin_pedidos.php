...
try {
    ...
    // Pedidos por mes (para gráfica) - usando fecha_pedido
...
<body class="bg-gray-100">
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Pedidos por Mes</h3>
                <div class="h-80">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Estado de Pedidos</h3>
                <div class="h-80">
    ...
    <script>
        ...
        const pedidosChart = new Chart(pedidosCtx, {
            type: 'line',
            data: {
                labels: <?php echo !empty($pedidos_por_mes) ? json_encode(array_column($pedidos_por_mes, 'mes')) : '[]'; ?>,
                datasets: [{
                    label: 'Cantidad de Pedidos',
                    data: <?php echo !empty($pedidos_por_mes) ? json_encode(array_column($pedidos_por_mes, 'cantidad')) : '[]'; ?>,
        ...
        const estadoPedidosChart = new Chart(estadoPedidosCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo $stats_pedidos['pendientes'] ?? 0; ?>,
                        <?php echo $stats_pedidos['completados'] ?? 0; ?>,
                        <?php echo $stats_pedidos['cancelados'] ?? 0; ?>
                    ],
                    backgroundColor: [
                        'rgb(245, 158, 11)',
                        'rgb(16, 185, 129)',
